...
gparted - program to do something

# SYNOPSIS

**gparted** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**gparted** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **gparted** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**gparted** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    gparted. See **foo.conf**(5) for further details.
...
**gparted** provides some return codes, that can be used in scripts:
...
kali <szymon.werema99@gmail.com>
